...
class RoombaNavigate():
    ...
    seconds_per_degree = 0.024  #found sketchily
    seconds_per_dist_unit = 0.3   #tuned for best experience
    def __init__(self):
        print 'start'
    ...
    def process_data(self, data):
        ...
        points = []
        maxy = float('-inf')
        for point in points_array:             #There may be jank code here to avoid bad values
    ...
    def move(self, lastx, lasty, x, y):
        ...
        beta = math.atan2(y, x)
        alpha = math.atan2(lastx, lasty)
        # diff_theta = new_theta - self.theta
        dist = math.sqrt((x - lastx) ** 2 + (y - lasty) ** 2)
        new_theta = math.asin(math.sqrt(x**2 + y**2) * math.sin(beta - alpha) / dist)
        # self.theta = new_theta
        self.rotate(new_theta)
        self.travel(dist)
    ...
    def travel(self, dist):
        ...
        print "travel time", dist * self.seconds_per_dist_unit
