        ...
        while True:
            ...
            if len(sys.argv) > 1:
                if sys.argv[1] == "-l":
                    ...
                    data = "{{{0, 0}, {5, 0}, {0, 0}, {5, 0}, {0, 0}, {5, 0}, {0, 0}, {5, 0}}, {2017, 9, 16, 20, 57, 22.505329`8.104860349327026}}[<||>]"
                elif sys.argv[1] == "-n":
                    ...
                    data = "{{{0, 0}, {4, 4}, {8, 0}, {12, 4}, {16, 0}}, {2017, 9, 16, 20, 57, 22.505329`8.104860349327026}}[<||>]"
